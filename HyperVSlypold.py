...
class hyperV():
    ...
    hyperv='rhydon'#parser.get('HyperV','hyperv')
	...
	p=subprocess.call(["powershell.exe","C:\\Users\\carbone\\Documents\\hypervimport.ps1"])
    def exportVHD(self):
        p=subprocess.call(["powershell.exe","C:\\Users\\carbone\\Documents\\hypervexport.ps1"])
        
    def PowerON(self):
        p=subprocess.call(["C:\\WINDOWS\\system32\\WindowsPowerShell\\v1.0\\powershell.exe","-NoProfile", "Start-VM", "-ComputerName", self.hyperv, "-Name", self.vmname, "|", "Out-File","ONHV"])
        
    def PowerOff(self):
        p=subprocess.call(["C:\\WINDOWS\\system32\\WindowsPowerShell\\v1.0\\powershell.exe","-NoProfile", "Stop-VM", "-ComputerName", self.hyperv, "-path", self.vmname, "|", "Out-File","OFFHV"])
